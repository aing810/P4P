...
function PageTwo() {
  ...
  const resultDetailsObj = {
    ...
    Cromwell: {
      ...
      incorrect: [{ expected: "Masterton", got: "Reefton" }],
    },
    Masterton: {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="flex w-full max-w-7xl h-full border rounded-lg overflow-hidden shadow-lg bg-white">
        ...
        <div className="flex flex-col w-1/3 border-r p-4 space-y-4">
          {" "}
          {/* Adjusted to take 1/3 of the space */}
        ...
        {/* Combined Middle and Right side: Maps, Charts, and additional content */}
        <div className="flex flex-col w-2/3 p-4 space-y-4">
          {" "}
          {/* Adjusted to take 2/3 of the space */}
